...
'''
database = r"./Contact-Info/contactinfo.db"
...
Button(root,text=" ADD", font='Times 14 bold',bg='MediumPurple2', command = create_task,width=8).place(x= 130, y=110)
Button(root,text="EDIT", font='Times 14 bold',bg='MediumPurple2',command = update_task,width=8).place(x= 260, y=108)
Button(root,text="DELETE", font='Times 14 bold',bg='MediumPurple2',command = delete_task,width=8).place(x= 390, y=107.5)
Button(root,text="VIEW ALL", font='Times 14 bold',bg='MediumPurple3', command = select_all_tasks,width=12).place(x= 160, y=191)
Button(root,text="VIEW BY NAME", font='Times 14 bold',bg='MediumPurple3', command = select_task_by_name,width=13).place(x= 330, y=190)
Button(root,text="EXIT", font='Times 14 bold',bg='MediumPurple4', command = EXIT,width=8).place(x= 200, y=280)
Button(root,text="RESET", font='Times 14 bold',bg='MediumPurple4', command = RESET,width=8).place(x= 320, y=280)
root.mainloop()